    ...
    <div className={
      ...
      <footer>
        ...
        <div className="socials">
          <a class="text-body-secondary" href="https://github.com/victoria-vu"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
